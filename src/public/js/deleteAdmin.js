document.addEventListener('DOMContentLoaded', function(){
      ...
      var itemCheckbox = $('input[name="adminIds[]"]');
      ...
      btnDelete.onclick = function () {
            deleteForm.action = '/admin/danh-sach-admin/' + ddID + '/force?_method=DELETE'; 
            deleteForm.submit();
      }
      ...
      restoreBtn.click( function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            restoreForm.action = '/admin/danh-sach-admin/' + id + '/khoi-phuc?_method=PATCH'; 
            restoreForm.submit();
      });
